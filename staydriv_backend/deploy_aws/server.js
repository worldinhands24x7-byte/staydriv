...
app.get('/api/booking/available', async (req, res) => {
  try {
    ...
    // A. Clean up stale online pilots (no activity in 5 minutes for mobile robustness)
    ...
    for (let b of bookings) {
      ...
      // Filter out pilots who declined this booking, are busy, or are not actively polling (lastActive older than 120 seconds)
