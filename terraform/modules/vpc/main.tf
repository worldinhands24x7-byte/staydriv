...
# single_nat_gateway = true creates 1 NAT Gateway for cost-efficiency.
# single_nat_gateway = false creates 1 per AZ for high availability.
...
# --- Private Application Route Table(s) ---
...
# --- Private Database Route Table (Isolated) ---
